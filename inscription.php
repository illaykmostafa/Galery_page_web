	...
	=========================
		...
		<nav id="main-navigation" class="nav-menu nav-menu-vertical nav-menu-right">
			<ul class="list-inline">
				...
				<li class="current"><a href="inscription.php">Inscription</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-offset-2 form-content ptb100">
							<h3 class="section-title wow fadeInDown">INSCRIPTION</h3>
							
							<div class="clearfix"></div>
							<form action="action.php" method="post" class="form wow fadeIn" data-wow-delay=".25s">
